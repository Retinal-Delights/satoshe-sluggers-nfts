...
export default function AttributeRarityChart({ attributes, overallRarity }: AttributeRarityProps) {
  ...
  if (!attributes || attributes.length === 0) {
    return (
      <Card className="flex flex-col bg-neutral-950/50 border border-neutral-800 mb-4 rounded-[2px]">
  ...
  return (
    <Card className="flex flex-col bg-neutral-950/50 border border-neutral-800 rounded-[2px]">

          ...
          <div className="w-full pl-4 pr-3 pt-3 pb-4">
            ...
            {isForSale ? (
              <div className="w-full flex items-center justify-between mt-2">
                ...
                <Link
                  href={`/nft/${cardNumber}${returnToUrl ? `?returnTo=${encodeURIComponent(returnToUrl)}` : ''}`}
                  className="px-3 py-1.5 rounded-sm font-normal transition-all duration-300 ease-in-out whitespace-nowrap flex-shrink-0 text-nft-button bg-blue-500/10 border border-blue-500 text-blue-400 hover:bg-blue-500/20 hover:border-blue-500 text-center"
              ...
              <div className="w-full flex items-center justify-between mt-2">
                ...
                <Link
                  href={`/nft/${cardNumber}${returnToUrl ? `?returnTo=${encodeURIComponent(returnToUrl)}` : ''}`}
                  className="px-3 py-1.5 rounded-sm font-normal transition-all duration-300 ease-in-out whitespace-nowrap flex-shrink-0 text-nft-button bg-[#00FF99]/10 border border-[#00FF99]/30 text-[#00FF99] hover:bg-[#00FF99]/20 hover:border-[#00FF99]/50 cursor-pointer"

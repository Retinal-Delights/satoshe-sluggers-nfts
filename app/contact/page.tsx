            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 md:space-y-6" aria-labelledby="contact-form-heading">
              ...
              <div className="flex justify-end pt-4 sm:pt-5 md:pt-6 pb-4 sm:pb-5 md:pb-6">
                <Button
                  ...
                  className="px-4 py-1.5 sm:px-5 sm:py-2 md:px-6 md:py-2 text-sm sm:text-base border border-brand-pink bg-transparent text-brand-pink font-normal rounded-[2px] hover:!bg-brand-pink hover:!text-off-white transition-all duration-300 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
                  aria-live="polite"
                >
                  {isSubmitting ? (
                    <>
